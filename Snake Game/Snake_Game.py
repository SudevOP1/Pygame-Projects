...
class SNAKE:
    def __init__(self):
        ...
        self.apple_eaten_sound = pygame.mixer.Sound(join("Data", "crunch_sound.wav"))
        self.snake_collision = pygame.mixer.Sound(join("Data", "snake_collision.mp3"))

        self.head_up = pygame.image.load(join("Data", "head_up.png")).convert_alpha()
        self.head_down = pygame.image.load(join("Data", "head_down.png")).convert_alpha()
        self.head_right = pygame.image.load(join("Data", "head_right.png")).convert_alpha()
        self.head_left = pygame.image.load(join("Data", "head_left.png")).convert_alpha()

        self.tail_up = pygame.image.load(join("Data", "tail_up.png")).convert_alpha()
        self.tail_down = pygame.image.load(join("Data", "tail_down.png")).convert_alpha()
        self.tail_right = pygame.image.load(join("Data", "tail_right.png")).convert_alpha()
        self.tail_left = pygame.image.load(join("Data", "tail_left.png")).convert_alpha()

        self.body_vertical = pygame.image.load(join("Data", "body_vertical.png")).convert_alpha()
        self.body_horizontal = pygame.image.load(join("Data", "body_horizontal.png")).convert_alpha()

        self.body_bl = pygame.image.load(join("Data", "body_bottomleft.png")).convert_alpha()
        self.body_br = pygame.image.load(join("Data", "body_bottomright.png")).convert_alpha()
        self.body_tl = pygame.image.load(join("Data", "body_topleft.png")).convert_alpha()
        self.body_tr = pygame.image.load(join("Data", "body_topright.png")).convert_alpha()
...
class FRUIT:
    def __init__(self):
        ...
        self.apple = pygame.image.load(join("Data", "apple.png"))
...
game_icon = pygame.image.load(join("Data", "icon.png")).convert_alpha()
pygame.display.set_icon(game_icon)
game_font_36 = pygame.font.Font(join("Data", "PoetsenOne-Regular.ttf"), 36)
game_font_40 = pygame.font.Font(join("Data", "PoetsenOne-Regular.ttf"), 40)
game_font_100 = pygame.font.Font(join("Data", "PoetsenOne-Regular.ttf"), 100)
game_active = True
main_game = MAIN()
bg_music = pygame.mixer.Sound(join("Data", "bg_music.mp3"))
